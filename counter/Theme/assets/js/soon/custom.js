...
(function($) {
    ...
    **/
    var launch = new Date(2016, 11, 31, 23, 59);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            hours.html('<h1>0</h1><p>Horaa</p>');
            minutes.html('<h1>0</h1><p>Minutos</p>');
            seconds.html('<h1>0</h1><p>Segundos</p>');
            message.html('NUESTRA WEB NO ESTA LISTA TODAVIA...');
        }
        else{
            ...
            message.html('<b>NUESTRA WEB NO ESTÁ LISTA TODAVÍA, PERO PRONTO LO ESTARÁ</b>');
        }
    }
})(jQuery);
/******************************************************************************************************************************
